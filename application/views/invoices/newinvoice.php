...
<?php endif;?>
	...
	<p id="dateIssuedContainer">
		<label><?php echo $this->lang->line('invoice_date_issued_full');?> <input type="text" name="dateIssued" id="dateIssued" value="<?php echo $invoiceDate; ?>"/></label><?php echo form_error('dateIssued'); ?>
	</p>
...
<?php endif;?>
	...
	<textarea name="invoice_note" id="invoice_note" cols="80" rows="3"><?php echo (set_value('invoice_note')) ? (set_value('invoice_note')) : ($invoice_note_default);?></textarea>
	</label>
	</p>
	<p>
