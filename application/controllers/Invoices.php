...
class Invoices extends MY_Controller {
	...
	function newinvoice()
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$data['invoiceDate'] = set_value('dateIssued');
	...
	function view($id)
	{
		$this->lang->load('date');
		//$this->load->helper('js_calendar');
		$this->load->helper(array('file', 'js_calendar'));
...
//		$invoice_number = $this->pdf($id, FALSE);
	...
	function _validation()
	{
        $rules = array(
            array(
                'field' => 'client_id',
                'label' => $this->lang->line('invoice_client_id'),
                'rules' => 'required|numeric'
            ),
            array(
                'field' => 'invoice_number',
                'label' => $this->lang->line('invoice_number'),
                'rules' => 'required|trim|htmlspecialchars|max_length[12]|alpha_dash|callback_uniqueInvoice'
            ),
            array(
                'field' => 'dateIssued',
                'label' => $this->lang->line('invoice_date_issued'),
                'rules' => 'trim|htmlspecialchars|callback_dateIssued'
            ),
            array(
                'field' => 'invoice_note',
                'label' => $this->lang->line('invoice_note'),
                'rules' => 'trim|htmlspecialchars|max_length[2000]'
            ),
            array(
                'field' => 'tax1_description',
                'label' => $this->lang->line('tax1_desc'),
                'rules' => 'trim|htmlspecialchars|max_length[50]'
            ),
            array(
                'field' => 'tax1_rate',
                'label' => $this->lang->line('tax1_rate'),
                'rules' => 'trim|htmlspecialchars'
            ),
            array(
                'field' => 'tax2_description',
                'label' => $this->lang->line('tax2_desc'),
                'rules' => 'trim|htmlspecialchars|max_length[50]'
            ),
            array(
                'field' => 'tax2_rate',
	...
	function _validation_edit()
	{
        $rules = array(
            ...
            array(
                'field' => 'invoice_number',
                'label' => $this->lang->line('invoice_number'),
                'rules' => 'trim|required|htmlspecialchars|max_length[50]|alpha_dash'
            ),
            array(
                'field' => 'dateIssued',
                'label' => $this->lang->line('invoice_date_issued'),
